...
#[test]
fn bindgen_test_layout__LibreOfficeKit() {
    assert_eq!(
        ::std::mem::size_of::<_LibreOfficeKit>(),
        8usize,
        concat!("Size of: ", stringify!(_LibreOfficeKit))
    );
    assert_eq!(
        ::std::mem::align_of::<_LibreOfficeKit>(),
        8usize,
        concat!("Alignment of ", stringify!(_LibreOfficeKit))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKit>())).pClass as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKit),
            "::",
            stringify!(pClass)
        )
    );
...
#[test]
fn bindgen_test_layout__LibreOfficeKitClass() {
    assert_eq!(
        ::std::mem::size_of::<_LibreOfficeKitClass>(),
        128usize,
        concat!("Size of: ", stringify!(_LibreOfficeKitClass))
    );
    assert_eq!(
        ::std::mem::align_of::<_LibreOfficeKitClass>(),
        8usize,
        concat!("Alignment of ", stringify!(_LibreOfficeKitClass))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).nSize as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(nSize)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).destroy as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).documentLoad as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(documentLoad)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).getError as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).documentLoadWithOptions as *const _
                as usize
        },
        32usize,
        concat!(
            ...
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(documentLoadWithOptions)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).freeError as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).registerCallback as *const _ as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).getFilterTypes as *const _ as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(getFilterTypes)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).setOptionalFeatures as *const _
                as usize
        },
        64usize,
        concat!(
            ...
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(setOptionalFeatures)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).setDocumentPassword as *const _
                as usize
        },
        72usize,
        concat!(
            ...
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(setDocumentPassword)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).getVersionInfo as *const _ as usize
        },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(getVersionInfo)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).runMacro as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).signDocument as *const _ as usize
        },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(signDocument)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).runLoop as *const _ as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitClass>())).sendDialogEvent as *const _ as usize
        },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
            "::",
            stringify!(sendDialogEvent)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitClass>())).setOption as *const _ as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitClass),
...
#[test]
fn bindgen_test_layout__LibreOfficeKitDocument() {
    assert_eq!(
        ::std::mem::size_of::<_LibreOfficeKitDocument>(),
        8usize,
        concat!("Size of: ", stringify!(_LibreOfficeKitDocument))
    );
    assert_eq!(
        ::std::mem::align_of::<_LibreOfficeKitDocument>(),
        8usize,
        concat!("Alignment of ", stringify!(_LibreOfficeKitDocument))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_LibreOfficeKitDocument>())).pClass as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitDocument),
            "::",
            stringify!(pClass)
        )
    );
...
#[test]
fn bindgen_test_layout__LibreOfficeKitDocumentClass() {
    assert_eq!(
        ::std::mem::size_of::<_LibreOfficeKitDocumentClass>(),
        32usize,
        concat!("Size of: ", stringify!(_LibreOfficeKitDocumentClass))
    );
    assert_eq!(
        ::std::mem::align_of::<_LibreOfficeKitDocumentClass>(),
        8usize,
        concat!("Alignment of ", stringify!(_LibreOfficeKitDocumentClass))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitDocumentClass>())).nSize as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_LibreOfficeKitDocumentClass),
            "::",
            stringify!(nSize)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitDocumentClass>())).destroy as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitDocumentClass>())).saveAs as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_LibreOfficeKitDocumentClass>())).getDocumentType as *const _
                as usize
        },
        24usize,
        concat!(
